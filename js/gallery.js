...
(() => {
  ...
  renderImages(imageElements);

  // Functions Declaration

  function renderImages(images) {
    galeryWrapper?.insertAdjacentHTML("afterbegin", images.join(""));
  }
  ...
  function onImageClick(e) {
    ...
    const instance = basicLightbox.create(
      `<img src="${originalImageURL}" alt="${e.target.alt}" />`
    );
    instance.show();
  }
  ...
  galeryWrapper?.addEventListener("click", onImageClick);
})();
